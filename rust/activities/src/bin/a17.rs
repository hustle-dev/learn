...
fn main() {
    let test_string1 = "HOHOHOHOHO";
    let test_string2 = "hohohohoho";
    println!(
        "test_string1 to lowercase : {:?}",
        test_string1.to_lowercase()
    );
    println!(
        "test_string2 to lowercase : {:?}",
        test_string2.to_uppercase()
    );
}
